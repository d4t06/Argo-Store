...
export const initInvoiceObject = (
...
export const initReceiptOject = (
	data: Partial<ReceiptSchema> & { user_email: string; customer_id: string },
) => {
	const newReceipt: ReceiptSchema = {
		price: 0,
		created_at: serverTimestamp(),
		...data,
	};
